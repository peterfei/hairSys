...
(43, '普通消费管理', 42, 'Cost', 'costList', '', 0, 0, '1'),
(44, '会员消费管理', 42, 'Member', 'memberList', '', 0, 0, '1'),
(50, '员工管理', 49, 'Employee', 'employeeList', '', 0, 0, '1'),
(49, '员工模块', 2, 'Employee', 'top', '', 0, 0, '1'),
(51, '收入统计模块', 1, 'Income', 'top', '', 0, 0, '1'),
(52, '门店收入', 51, 'Income', 'incomeList', '', 0, 0, '1'),
(55, '加入会员明细', 42, 'Member', 'memberAddDetail', '', 0, 0, '0'),
(54, '面板', 53, 'Index', 'index', '', 0, 0, '1'),
(56, '加入明细', 42, 'Member', 'memberAdd', '', 0, 0, '0'),
(57, '明细列表显示', 42, 'MemberDetail', 'detailList', '', 0, 0, '0'),
