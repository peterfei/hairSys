...
<table id="setting_site_propertygrid" class="easyui-propertygrid" data-options='<?php $dataOptions = array_merge(array ( 'border' => false, 'fit' => true, 'showHeader' => true, 'columns' => array ( 0 => array ( 0 => array ( 'field' => 'name', 'title' => '属性名称', 'width' => 40, 'sortable' => true, ), 1 => array ( 'field' => 'value', 'title' => '属性值', 'width' => 40, ), ), ), 'showGroup' => true, 'scrollbarSize' => 0, ), $propertygrid["options"]);if(isset($dataOptions['toolbar']) && substr($dataOptions['toolbar'],0,1) != '#'): unset($dataOptions['toolbar']); endif; echo trim(json_encode($dataOptions), '{}[]').((isset($propertygrid["options"]['toolbar']) && substr($propertygrid["options"]['toolbar'],0,1) != '#')?',"toolbar":'.$propertygrid["options"]['toolbar']:null); ?>' style=""></table>
